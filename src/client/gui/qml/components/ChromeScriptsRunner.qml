...
Window {
    id: root
    objectName: "chromeScriptsRunner"
    title: "Прогон скриптов Chrome - Chrome Profile Manager"
    color: "#f5f5f5"
    ...
    Connections {
        ...
        function onScriptOperationStatusChanged(success, message) {
            isProcessing = false
    ...
    function updateSelectedScripts() {
        ...
        for (var i = 0; i < scriptsListView.count; i++) {
            ...
            if (item && item.children[0].checked) {
                selectedScripts.push(profileManager.chromeScriptsList[i])
            }
        }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    CheckBox {
                        id: headlessModeCheckbox
                        text: "Использовать Headless Mode"
                        Layout.fillWidth: true
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    ListView {
                        ...
                        model: profileManager.chromeScriptsList
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                // Новая реализация кнопки запуска скриптов
                Rectangle {
                    id: runButtonRect
                    Layout.fillWidth: true
                    Layout.preferredHeight: 40
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            if (selectedProfiles.length > 0 && selectedScripts.length > 0 && !isProcessing) {
                                ...
                                console.log("Headless Mode:", useHeadlessMode)
                                ...
                                try {
                                    ...
                                    profileManager.runChromeScripts(selectedScripts, useHeadlessMode)
                                    console.log("===== МЕТОД runChromeScripts ВЫЗВАН =====")
                                } catch (e) {
                                    console.log("===== ОШИБКА ПРИ ВЫЗОВЕ runChromeScripts =====", e)
                                    isProcessing = false
